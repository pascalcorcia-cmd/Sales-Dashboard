    ...
    <>
      ...
      <form onSubmit={handleSubmit} style={styles.inputForm}>
        <input
          ...
          disabled={loading}
        />
        <button type="button" onClick={() => setShowUpload(!showUpload)} style={styles.iconBtn} title="Upload fichier">
          📎
        </button>
        <button type="button" onClick={handleNewChat} style={styles.iconBtn} title="Nouvelle conversation">
          ✨
        </button>
