...
export default function AccountPlanning() {
  ...
  const sendInitialPrompt = async () => {
    const prompt = "Je veux préparer un rendez-vous commercial. Aide-moi à : 1) Identifier les enjeux clés du prospect, 2) Préparer mes arguments de valeur, 3) Structurer mon pitch de 10 minutes, 4) Anticiper les objections"
      ...
      <div style={styles.messages}>
        {messages.length === 0 && (
          <div style={styles.welcome}>
            <h2 style={styles.welcomeTitle}>📊 Préparation Rendez-vous</h2>
            <p style={styles.welcomeText}>Préparez votre rendez-vous commercial avec l'IA</p>
